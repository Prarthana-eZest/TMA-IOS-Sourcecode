//
//  EarningDetailsTViewTrendHeaderCell.swift
//  Enrich_TMA
//
//  Created by Harshal on 26/12/21.
...
@objc protocol EarningDetailsViewTrendDelegate: class {
    func reloadData()
...
class EarningDetailsTViewTrendHeaderCell: UITableViewCell, ChartViewDelegate {
...
extension EarningDetailsTViewTrendHeaderCell {

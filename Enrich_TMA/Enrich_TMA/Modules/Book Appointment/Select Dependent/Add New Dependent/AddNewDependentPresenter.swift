//
//  AddNewDependentPresenter.swift
//  Enrich_TMA
//
...
protocol AddNewDependentPresentationLogic
{
    func presentSuccess<T: Decodable>(response: T)
    func presentError(responseError: String?)
}

class AddNewDependentPresenter: AddNewDependentPresentationLogic
{
    weak var viewController: AddNewDependentDisplayLogic?

//
//  SelectStylistAndTimeslotPresenter.swift
//  Enrich_TMA
//
...
protocol SelectStylistAndTimeslotPresentationLogic
{
    func presentSuccess<T: Decodable>(response: T)
    func presentError(responseError: String?)
}

class SelectStylistAndTimeslotPresenter: SelectStylistAndTimeslotPresentationLogic
{
    weak var viewController: SelectStylistAndTimeslotDisplayLogic?

...
protocol TeleConsultationPresentationLogic {
    func presentSuccess<T: Decodable>(response: T)
    func presentError(responseError: String?)
}

class TeleConsultationPresenter: TeleConsultationPresentationLogic {
    weak var viewController: TeleConsultationDisplayLogic?

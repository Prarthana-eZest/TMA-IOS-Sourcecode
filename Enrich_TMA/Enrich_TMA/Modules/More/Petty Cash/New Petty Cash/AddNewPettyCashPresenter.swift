//
//  AddNewPettyCashPresenter.swift
//  Enrich_TMA
//
...
protocol AddNewPettyCashPresentationLogic {
    func presentSuccess<T: Decodable>(response: T)
    func presentError(responseError: String?)
}

class AddNewPettyCashPresenter: AddNewPettyCashPresentationLogic {
    weak var viewController: AddNewPettyCashDisplayLogic?

...
protocol PackageListingPresentationLogic {
    func presentSuccess<T: Decodable>(response: T)
    func presentError(responseError: String?)
}

class PackageListingPresenter: PackageListingPresentationLogic {
    weak var viewController: PackageListingDisplayLogic?

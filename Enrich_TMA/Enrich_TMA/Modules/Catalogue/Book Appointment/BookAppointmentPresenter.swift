//
//  BookAppointmentPresenter.swift
//  Enrich_TMA
//
...
protocol BookAppointmentPresentationLogic {
    func presentSuccess<T: Decodable>(response: T)
    func presentError(responseError: String?)
}

class BookAppointmentPresenter: BookAppointmentPresentationLogic {
    weak var viewController: BookAppointmentDisplayLogic?

//
//  RateTheProductModulePresenter.swift
//  EnrichSalon
//
...
//protocol RateTheProductModulePresentationLogic
//{
//    func presentSomethingSuccess<T:Decodable>(response: T)
//    func presentSomethingError(responseError: String?)
//}
protocol RateTheProductModulePresentationLogic: CartManagerPresentationLogic {
}

class RateTheProductModulePresenter: RateTheProductModulePresentationLogic {
  weak var viewController: RateTheProductModuleDisplayLogic?

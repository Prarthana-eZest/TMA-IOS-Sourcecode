...
class AwardsViewController: UIViewController, AwardsDisplayLogic
{
  ...
  override func prepare(for segue: UIStoryboardSegue, sender: Any?)
  {
    ...
    //        }
        ...
        func getTotalAwardsGraphEntry(forData data:[Dashboard.GetRevenueDashboard.RevenueTransaction]? = nil, dateRange:DateRange, dateRangeType: DateRangeType) -> GraphDataEntry
        {
            let units = xAxisUnits(forDateRange: dateRange, rangeType: dateRangeType)
        ...
        func totalAwardsGraphData(forData data:[Dashboard.GetRevenueDashboard.RevenueTransaction]? = nil, dateRange:DateRange, dateRangeType: DateRangeType) -> [Double]
        {
    ...
    //        return totalFixedEarnings
        ...
        func updateAwardsData(atIndex indexPath:IndexPath, withStartDate startDate: Date?, endDate: Date = Date().startOfDay, rangeType:DateRangeType) {

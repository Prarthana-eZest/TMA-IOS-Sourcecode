...
class IncentiveViewController: UIViewController, IncentiveDisplayLogic
{
  ...
  //        }
      ...
      func getTotalIncentiveGraphEntry(forData data:[Dashboard.GetRevenueDashboard.RevenueTransaction]? = nil, dateRange:DateRange, dateRangeType: DateRangeType) -> GraphDataEntry
      {
          let units = xAxisUnits(forDateRange: dateRange, rangeType: dateRangeType)
  ...
  //        return totalIncentive
    ...
    func updateIncentiveData(atIndex indexPath:IndexPath, withStartDate startDate: Date?, endDate: Date = Date().startOfDay, rangeType:DateRangeType) {

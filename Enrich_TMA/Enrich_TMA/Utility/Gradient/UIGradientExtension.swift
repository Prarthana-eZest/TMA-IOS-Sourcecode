...
public extension UIColor {
    ...
    static func fromGradientWithDirectionAndColor(_ direction: GradientDirection, frame: CGRect, colors: [UIColor], cornerRadius: CGFloat = 0, locations: [Double]? = nil) -> UIColor? {
    ...
    static func fromGradientWithDirection(_ gradient: GradientLayer, frame: CGRect, cornerRadius: CGFloat = 0, direction: GradientDirection) -> UIColor? {
